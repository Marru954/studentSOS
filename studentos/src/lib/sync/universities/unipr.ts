...
const livePrograms: LiveProgram[] = [
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "biotecnologie-mediche-veterinarie-e-farmaceutiche", "", [
      { year: 1, corso: "5140", anno2: ["420|1", "319|1", "455|1"] },
      { year: 2, corso: "5140", anno2: ["322|2", "420|2", "319|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "chimica-triennale", "", [
      ...
      { year: 2, corso: "5115", anno2: ["416|2", "417|2"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "chimica-e-tecnologia-farmaceutiche", "", [
      ...
      { year: 2, corso: "5122", anno2: ["GEN|2"] },
      { year: 3, corso: "5080", anno2: ["GEN|3"] },
      { year: 4, corso: "5080", anno2: ["GEN|4"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "costruzioni-infrastrutture-e-territorio", "", [
      { year: 1, corso: "3059", anno2: ["GEOM e PI Laureato|1"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "ecologia-ed-etologia-per-la-conservazione-della-natura", "", [
      ...
      { year: 2, corso: "5117", anno2: ["348|2", "349|2"] },
    ]),
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "economia-e-management", "", [
      ...
      { year: 2, corso: "3124", anno2: ["226|2", "228|2", "229|2", "230|2", "336|2"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "economia-e-management-delle-filiere-alimentari-sostenibili", "", [
      ...
      { year: 2, corso: "3125", anno2: ["GEN|2"] },
      { year: 3, corso: "3072", anno2: ["393|3", "394|3"] },
    ]),
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "economics-and-management-of-sustainable-food-system", "", [
      ...
      { year: 2, corso: "5129", anno2: ["419|2", "418|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "farmacia", "", [
      ...
      { year: 2, corso: "5123", anno2: ["GEN|2"] },
      { year: 3, corso: "5079", anno2: ["GEN|3"] },
      { year: 4, corso: "5079", anno2: ["GEN|4"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "fisioterapia-abilitante-alla-professione-sanitaria-di-fisioterapista", "", [
      { year: 1, corso: "3133PR", anno2: ["GEN|1"] },
    ]),
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "food-safety-and-food-risk-management", "", [
      ...
      { year: 2, corso: "5124", anno2: ["354|2", "421|2", "355|2", "356|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "giornalismo-cultura-editoriale-comunicazione-ambientale-e-multimediale", "", [
      ...
      { year: 2, corso: "5105", anno2: ["388|2", "363|2", "364|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "ingegneria-civile", "", [
      ...
      { year: 2, corso: "5112", anno2: ["248|2", "146|2", "341|2", "342|2", "343|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "ingegneria-delle-tecnologie-informatiche", "", [
      ...
      { year: 2, corso: "3115", anno2: ["409|2", "391|2", "410|2"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "ingegneria-gestionale-triennale", "", [
      ...
      { year: 2, corso: "3110", anno2: ["365|2", "391|2", "366|2", "262|2", "401|2"] },
      { year: 3, corso: "3010", anno2: ["365|3", "391|3", "366|3", "262|3", "401|3"] },
    ]),
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "ingegneria-gestionale-magistrale", "", [
      ...
      { year: 2, corso: "5014", anno2: ["350|2", "413|2", "351|2", "347|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "ingegneria-meccanica-triennale", "", [
      ...
      { year: 2, corso: "3111", anno2: ["261|2", "398|2", "399|2"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "language-sciences-and-cultural-studies-for-special-needs", "", [
      { year: 1, corso: "5073", anno2: ["406|1", "408|1", "453|1"] },
      { year: 2, corso: "5073", anno2: ["407|2", "406|2", "408|2"] },
    ]),
  },
  {
    programme: "Lettere",
    sources: degreeSources(BASE, ANNO, "lettere", "", [
      ...
      { year: 2, corso: "3103", anno2: ["332|2", "424|2", "040|2", "340|2"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "psicologia-dell-intervento-clinico-e-sociale", "", [
      ...
      { year: 2, corso: "5107", anno2: ["412|2", "411|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "scienze-biomediche-traslazionali", "", [
      ...
      { year: 2, corso: "5118", anno2: ["359|2", "357|2", "358|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "scienze-dell-educazione-e-dei-processi-formativi", "", [
      ...
      { year: 2, corso: "3105", anno2: ["361|2", "362|2"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "scienze-e-tecnologie-per-l-ambiente-e-le-risorse", "", [
      ...
      { year: 2, corso: "5121", anno2: ["372|2", "373|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "studi-filosofici", "", [
      ...
      { year: 2, corso: "3106", anno2: ["422|2", "423|2"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "trade-e-consumer-marketing", "", [
      ...
      { year: 2, corso: "5132", anno2: ["GEN|2"] },
    ]),
  },
  {
    programme: "Architettura e Città Sostenibili",
    sources: degreeSources(BASE, ANNO, "architettura-e-citta-sostenibili", "", [
      { year: 1, corso: "5111", anno2: ["GEN|1"] },
      { year: 2, corso: "5111", anno2: ["367|2", "368|2", "369|2"] },
    ], false),
  },
  {
    programme: "Architettura Rigenerazione Sostenibilità",
    sources: degreeSources(BASE, ANNO, "architettura-rigenerazione-sostenibilita", "", [
      { year: 1, corso: "3112", anno2: ["GEN|1"] },
      { year: 2, corso: "3112", anno2: ["GEN|2"] },
    ], false),
  },
  {
    programme: "Financial Management per Imprese, Mercati e Intermediari",
    sources: degreeSources(BASE, ANNO, "financial-management-per-imprese-mercati-e-intermediari", "", [
      { year: 1, corso: "5145", anno2: ["GEN|1"] },
    ], false),
  },
  {
    programme: "Fisioterapia (abilitante alla Professione Sanitaria di Fisioterapista) - Secondo e",
    sources: degreeSources(BASE, ANNO, "fisioterapia-abilitante-alla-professione-sanitaria-di-fisioterapista-secondo-e", "", [
      { year: 2, corso: "3042", anno2: ["GEN_PAR|2", "GEN_PIA|2"] },
      { year: 3, corso: "3042", anno2: ["GEN_PAR|3", "GEN_PIA|3"] },
    ], false),
  },
  {
    programme: "Fisioterapia Sede Piacenza (abilitante alla Professione Sanitaria di Fisioterapista)",
    sources: degreeSources(BASE, ANNO, "fisioterapia-sede-piacenza-abilitante-alla-professione-sanitaria-di-fisioterapista", "", [
      { year: 1, corso: "3133PC", anno2: ["GEN|1"] },
    ], false),
  },
  {
    programme: "Infermieristica (abilitante alla Professione Sanitaria di Infermiere) - Secondo e",
    sources: degreeSources(BASE, ANNO, "infermieristica-abilitante-alla-professione-sanitaria-di-infermiere-secondo-e", "", [
      { year: 2, corso: "3040", anno2: ["AOU_PR|2", "AUSL_PR|2", "AUSL_PC|2"] },
      { year: 3, corso: "3040", anno2: ["AOU_PR|3", "AUSL_PR|3", "AUSL_PC|3"] },
    ], false),
  },
  {
    programme: "Infermieristica Sede Aou (abilitante alla Professione Sanitaria di Infermiere)",
    sources: degreeSources(BASE, ANNO, "infermieristica-sede-aou-abilitante-alla-professione-sanitaria-di-infermiere", "", [
      { year: 1, corso: "3132AZ", anno2: ["GEN|1"] },
    ], false),
  },
  {
    programme: "Infermieristica Sede Ausl (abilitante alla Professione Sanitaria di Infermiere)",
    sources: degreeSources(BASE, ANNO, "infermieristica-sede-ausl-abilitante-alla-professione-sanitaria-di-infermiere", "", [
      { year: 1, corso: "3132PR", anno2: ["GEN|1"] },
    ], false),
  },
  {
    programme: "Infermieristica Sede Piacenza (abilitante alla Professione Sanitaria di Infermiere)",
    sources: degreeSources(BASE, ANNO, "infermieristica-sede-piacenza-abilitante-alla-professione-sanitaria-di-infermiere", "", [
      { year: 1, corso: "3132PC", anno2: ["GEN|1"] },
    ], false),
  },
  {
    programme: "Ingegneria Gestionale (prevalentemente a Distanza)",
    sources: degreeSources(BASE, ANNO, "ingegneria-gestionale-prevalentemente-a-distanza", "", [
      { year: 1, corso: "3131", anno2: ["GEN|1"] },
    ], false),
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "medicina-e-chirurgia-primo-e", "", [
      ...
      { year: 2, corso: "5137", anno2: ["GEN|2"] },
    ], false),
  },
  {
    programme: "Medicina Veterinaria - Primo e",
    sources: degreeSources(BASE, ANNO, "medicina-veterinaria-primo-e", "", [
      { year: 1, corso: "5135", anno2: ["GEN|1"] },
      { year: 2, corso: "5135", anno2: ["GEN|2"] },
    ], false),
  },
  {
    programme: "Medicine And Surgery - Primo e",
    sources: degreeSources(BASE, ANNO, "medicine-and-surgery-primo-e", "", [
      { year: 1, corso: "5138", anno2: ["GEN|1"] },
      { year: 2, corso: "5138", anno2: ["GEN|2"] },
    ], false),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "scienze-infermieristiche-e-ostetriche-profilo-infermieristico", "", [
      { year: 1, corso: "5146", anno2: ["GEN|1"] },
    ], false),
  },
  {
    programme: "Scienze, Tecniche e Management dello Sport e delle Organizzazioni Sportive",
    sources: degreeSources(BASE, ANNO, "scienze-tecniche-e-management-dello-sport-e-delle-organizzazioni-sportive", "", [
      { year: 1, corso: "5144", anno2: ["GEN|1"] },
    ], false),
  },
  {
    programme: "Semestre Aperto",
    sources: degreeSources(BASE, ANNO, "semestre-aperto", "", [
      { year: 1, corso: "SFM", anno2: ["PDS0-2026|1"] },
    ], false),
  },
];
