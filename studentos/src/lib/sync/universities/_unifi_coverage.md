> **Nota (2026-09-25, merge del branch easyacademy-preset-codes):** le tabelle "Ri-verifica 2026/27" qui sotto descrivono la ri-cattura manuale fatta su quel branch. Su `main` i preset sono stati poi rigenerati con `scripts/recapture-codes.ts --exams-rule` (criterio: anno vivo se `grid_call` dà celle in almeno una di 6 settimane campione; esami solo con appelli 2026/27): i conteggi possono differire, fa fede il codice del preset.
