...
const livePrograms: LiveProgram[] = [
  {
    ...
    sources: degreeSources(BASE, ANNO, "accounting-auditing-e-controllo", "ScuoladiEconomiaeManagement", [
      ...
      { year: 2, corso: "B377", anno2: ["F033|2", "F074|2", "F032|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "biotecnologie", "ScuoladiScienzedellaSaluteUmana", [
      { year: 2, corso: "B301", anno2: ["D72|2", "D70|2", "D71|2"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "biotecnologie-mediche-e-farmaceutiche", "ScuoladiScienzedellaSaluteUmana", [
      { year: 1, corso: "B353", anno2: ["F100|1", "F099|1", "F101|1", "F102|1"] },
      { year: 2, corso: "B353", anno2: ["GEN|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "economics-and-development-magistrale", "ScuoladiEconomiaeManagement", [
      ...
      { year: 2, corso: "B418", anno2: ["E20|2", "E19|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "governo-e-direzione-d-impresa", "ScuoladiEconomiaeManagement", [
      ...
      { year: 2, corso: "B426", anno2: ["B72|2", "B73|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "ingegneria-ambientale", "ScuoladiIngegneria", [
      ...
      { year: 2, corso: "B305", anno2: ["F046|2", "F048|2", "F047|2"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "ingegneria-civile-e-edile-per-la-sostenibilita", "ScuoladiIngegneria", [
      { year: 1, corso: "B306", anno2: ["F108|1", "F107|1", "F106|1"] },
      { year: 2, corso: "B306", anno2: ["F062|2", "F064|2", "F063|2"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "ingegneria-dei-sistemi-elettronici", "ScuoladiIngegneria", [
      { year: 1, corso: "B337", anno2: ["F098|1", "F020|1", "F097|1", "F023|1"] },
      { year: 2, corso: "B337", anno2: ["F022|2", "F021|2", "F020|2", "F023|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "ingegneria-energetica", "ScuoladiIngegneria", [
      { year: 1, corso: "B410", anno2: ["E83|1", "F116|1", "E84|1"] },
      { year: 2, corso: "B410", anno2: ["E83|2", "E84|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "ingegneria-informatica-magistrale", "ScuoladiIngegneria", [
      ...
      { year: 2, corso: "B308", anno2: ["E70|2", "E69|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "ingegneria-meccanica-magistrale", "ScuoladiIngegneria", [
      ...
      { year: 2, corso: "B412", anno2: ["E05|2", "E61|2", "E90|2", "E06|2", "E42|2", "E41|2", "E72|2", "E73|2"] },
    ]),
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "ingegneria-meccanica-triennale", "ScuoladiIngegneria", [
      ...
      { year: 2, corso: "B309", anno2: ["F052_A-L|2", "F052_M-Z|2", "F051_A-L|2", "F051_M-Z|2", "F054_A-L|2", "F054_M-Z|2", "F053_A-L|2", "F053_M-Z|2", "F055_A-L|2", "F055_M-Z|2", "F077_A-L|2", "F077_M-Z|2", "F078_A-L|2", "F078_M-Z|2"] },
      { year: 3, corso: "B049", anno2: ["F052|3", "F051|3", "F054|3", "F053|3", "F055|3", "F077|3", "F078|3"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "innovazione-sostenibile-in-viticoltura-ed-enologia-b424", "ScuoladiAgraria", [
      ...
      { year: 2, corso: "B424", anno2: ["F093|2", "F094|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "lingue-letterature-e-studi-interculturali", "ScuoladiStudiUmanisticiedellaFormazione", [
      { year: 3, corso: "B004", anno2: ["LETI3|3", "C09|3", "C80|3", "D42|3"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "relazioni-internazionali-e-studi-europei", "ScuoladiScienzePoliticheCesareAlfieri", [
      ...
      { year: 2, corso: "B416", anno2: ["B416_LM 52|2", "B416_LM 90|2", "GEN|2"] },
    ]),
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "robotics-automation-and-electrical-engineering", "ScuoladiIngegneria", [
      ...
      { year: 2, corso: "B336", anno2: ["F080|2", "F079|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "scienze-della-natura-e-dell-uomo", "ScuoladiScienzeMatematiche-FisicheeNaturali", [
      ...
      { year: 2, corso: "B372", anno2: ["D28|2", "F034|2", "D51|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "scienze-e-tecnologie-agrarie-b375", "ScuoladiAgraria", [
      { year: 1, corso: "B375", anno2: ["F113|1", "F115|1", "F114|1"] },
      { year: 2, corso: "B375", anno2: ["E92|2", "E53|2", "F065|2", "C45|2", "C47|2", "E91|2"] },
    ]),
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "scienze-e-tecnologie-dei-sistemi-forestali-b425", "ScuoladiAgraria", [
      ...
      { year: 2, corso: "B425", anno2: ["F090|2", "F091|2", "F092|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "scienze-filosofiche", "ScuoladiStudiUmanisticiedellaFormazione", [
      ...
      { year: 2, corso: "B378", anno2: ["F042|2", "F043|2", "F040|2", "F041|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "scienze-politiche-triennale", "ScuoladiScienzePoliticheCesareAlfieri", [
      { year: 3, corso: "B037", anno2: ["D76|3", "F085|3", "D77|3", "D75|3", "D78|3"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "viticoltura-ed-enologia-b399", "ScuoladiAgraria", [
      ...
      { year: 2, corso: "B399", anno2: ["GEN|2"] },
    ]),
  },
  {
    programme: "A-greentech - Tecnologie Avanzate per L'agricoltura Verde [b437]",
    sources: degreeSources(BASE, ANNO, "a-greentech-tecnologie-avanzate-per-l-agricoltura-verde-b437", "ScuoladiAgraria", [
      { year: 1, corso: "B437", anno2: ["GEN|1"] },
    ], false),
  },
  {
    programme: "Advanced Chemical Sciences And Technologies",
    sources: degreeSources(BASE, ANNO, "advanced-chemical-sciences-and-technologies", "ScuoladiScienzeMatematiche-FisicheeNaturali", [
      { year: 1, corso: "B432", anno2: ["GEN|1"] },
    ], false),
  },
  {
    programme: "Bio-tmp",
    sources: degreeSources(BASE, ANNO, "bio-tmp", "ScuoladiAgraria", [
      { year: 3, corso: "bio-tmp", anno2: ["bio-tmp|3"] },
    ], false),
  },
  {
    programme: "Biotecnologie Applicate Alle Scienze della Salute Umana",
    sources: degreeSources(BASE, ANNO, "biotecnologie-applicate-alle-scienze-della-salute-umana", "ScuoladiScienzedellaSaluteUmana", [
      { year: 1, corso: "B428", anno2: ["GEN|1"] },
    ], false),
  },
  {
    programme: "Biotecnologie Molecolari e delle Produzioni Sostenibili",
    sources: degreeSources(BASE, ANNO, "biotecnologie-molecolari-e-delle-produzioni-sostenibili", "ScuoladiScienzeMatematiche-FisicheeNaturali", [
      { year: 1, corso: "B434", anno2: ["F096|1", "F095|1"] },
    ], false),
  },
  {
  ...
  {
    programme: "Geological Hazards And Environmental Sustainability",
    sources: degreeSources(BASE, ANNO, "geological-hazards-and-environmental-sustainability", "ScuoladiScienzeMatematiche-FisicheeNaturali", [
      { year: 1, corso: "B435", anno2: ["GEN|1"] },
    ], false),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "medicine-and-surgery", "ScuoladiScienzedellaSaluteUmana", [
      { year: 1, corso: "B436", anno2: ["GEN|1"] },
    ], false),
  },
  {
  ...
  {
    programme: "Product, Interior, Communication And Eco-social Design - Firenze",
    sources: degreeSources(BASE, ANNO, "product-interior-communication-and-eco-social-design-firenze", "ScuoladiArchitettura", [
      { year: 2, corso: "B303_FIRENZE", anno2: ["GEN|2"] },
    ], false),
  },
  {
  ...
  {
    programme: "Scienze della Formazione Primaria (iii, Iv, )",
    sources: degreeSources(BASE, ANNO, "scienze-della-formazione-primaria-iii-iv", "ScuoladiStudiUmanisticiedellaFormazione", [
      { year: 3, corso: "B198_1", anno2: ["GEN|3"] },
      { year: 4, corso: "B198_1", anno2: ["GEN|4"] },
      { year: 5, corso: "B198_1", anno2: ["GEN|5"] },
    ], false),
  },
  {
    programme: "Scienze delle Professioni Sanitarie della Prevenzione",
    sources: degreeSources(BASE, ANNO, "scienze-delle-professioni-sanitarie-della-prevenzione", "ScuoladiScienzedellaSaluteUmana", [
      { year: 1, corso: "B184", anno2: ["GEN|1"] },
      { year: 2, corso: "B184", anno2: ["GEN|2"] },
    ], false),
  },
  {
    programme: "Scienze delle Professioni Sanitarie Tecniche Diagnostiche",
    sources: degreeSources(BASE, ANNO, "scienze-delle-professioni-sanitarie-tecniche-diagnostiche", "ScuoladiScienzedellaSaluteUmana", [
      { year: 1, corso: "B183", anno2: ["GEN|1"] },
      { year: 2, corso: "B183", anno2: ["GEN|2"] },
    ], false),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "semestre-aperto", "ScuoladiScienzedellaSaluteUmana", [
