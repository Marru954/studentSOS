 ...
 *
 * September re-verification (2026-09-25): codes re-captured from combo.php aa=2026; every
 * timetable source verified with 10 weekly POSTs (28-09..30-11-2026, celle > 0 in at least
 * one week); years without celle were removed (manual) — originals in _unisa_coverage.md.
 * `false` (last arg) = timetable only: test_call has no Appelli in 2026/27 (strict rule).
 * Note: the duplicated "Informatica (magistrale)" / "Informatica - Nf225" programmes both
 * resolve to corso NF225 (same data, distinct source ids).
 */
...
const livePrograms: LiveProgram[] = [
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "informatica-magistrale", "300392", [
      ...
      { year: 2, corso: "NF225", anno2: ["NF225P0007|2", "NF225P0010|2", "NF225P0009|2", "NF225P0006|2", "NF225P0011|2"] },
    ], false),
  },
  {
