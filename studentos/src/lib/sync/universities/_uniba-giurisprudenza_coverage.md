...
## Ri-verifica 2026/27 — 2026-09-25: preset passato a MODALITÀ MANUALE (sistema non pronto)
...
- Applicando la regola rigida il preset sarebbe interamente vuoto (0 sorgenti live). Il preset è ora in **modalità manuale** (`liveSources:false`, nessun `livePrograms`; i 12 corsi restano selezionabili in onboarding come manuali). Codici originali 2025/26 conservati verbatim in `UNIBA_LIVE_PROGRAMS_2025_26` (uniba.ts) per il ripristino; da ri-verificare quando compare aa=2026 nel combo o vengono pubblicati gli orari. Codici e stato 2025/26 nelle tabelle sotto restano come storico.
