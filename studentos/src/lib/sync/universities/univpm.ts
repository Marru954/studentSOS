...
const livePrograms: LiveProgram[] = [
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "biologia-molecolare-e-applicata", "Scienze", [
      ...
      { year: 2, corso: "SM24", anno2: ["BMA2|2", "BMA1|2"] },
    ]),
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "data-science-for-economics-business-and-finance", "Economia", [
      { year: 1, corso: "EM33", anno2: ["650|1", "651|1"] },
      { year: 2, corso: "EM31", anno2: ["650|2", "651|2"] },
    ], false),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "economia-aziendale", "Economia", [
      { year: 1, corso: "ET25", anno2: ["642|1", "652|1", "643|1"] },
      { year: 2, corso: "ET25", anno2: ["642|2", "643|2"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "economia-e-management", "Economia", [
      ...
      { year: 2, corso: "EM23", anno2: ["645|2", "647|2", "646|2"] },
    ], false),
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "educazione-professionale-abilitante-alla-professione-sanitaria-di-educatore-professionale", "Medicina", [
      { year: 1, corso: "MT08", anno2: ["GEN|1"] },
      { year: 3, corso: "MT08", anno2: ["GEN|3"] },
    ]),
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "environmental-hazard-and-disaster-risk-management", "Scienze", [
      { year: 1, corso: "SM25", anno2: ["GEN|1"] },
      { year: 2, corso: "SM25", anno2: ["PDS0-2016|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: [
      ...
      ...degreeSources(BASE, ANNO, "fisioterapia-abilitante-alla-professione-sanitaria-di-fisioterapista-sede-ascoli-piceno", "Medicina", [
      { year: 2, corso: "MT01A", anno2: ["GEN|2"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "infermieristica-abilitante-alla-professione-sanitaria-di-infermiere-sede-ascoli-piceno", "Medicina", [
      ...
      { year: 3, corso: "MT02A", anno2: ["GEN|3"] },
    ], false),
  },
  {
    ...
    sources: [
      ...
      { year: 3, corso: "MT02F", anno2: ["GEN|3"] },
      ], false),
    ],
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "infermieristica-abilitante-alla-professione-sanitaria-di-infermiere-sede-pesaro", "Medicina", [
      ...
      { year: 2, corso: "MT02P", anno2: ["GEN|2"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "international-economics-and-commerce", "Economia", [
      ...
      { year: 2, corso: "EM27", anno2: ["636|2", "649|2", "648|2"] },
    ], false),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "scienze-agrarie-e-del-territorio", "Agraria", [
      ...
      { year: 2, corso: "AM21", anno2: ["410|2", "412|2", "411|2"] },
    ]),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "scienze-biologiche", "Scienze", [
      ...
      { year: 2, corso: "ST21", anno2: ["SB01|2", "SB02|2"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "scienze-e-tecnologie-agrarie", "Agraria", [
      ...
      { year: 2, corso: "AT21", anno2: ["408|2", "409|2"] },
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "scienze-economiche-e-finanziarie", "Economia", [
      ...
      { year: 2, corso: "EM21", anno2: ["640|2", "644|2"] },
    ], false),
  },
  {
  ...
  },
  {
    ...
    sources: degreeSources(BASE, ANNO, "terapia-della-neuro-e-psicomotricita-dell-eta-evolutiva-abilitante-alla-professione-sanitaria-di-terapista-della-neuro-e-psicomotricita-dell-eta-evolutiva", "Medicina", [
      { year: 1, corso: "MT14", anno2: ["GEN|1"] },
      { year: 3, corso: "MT14", anno2: ["GEN|3"] },
    ], false),
  },
  {
    programme: "Scienze Infermieristiche e Ostetriche - Profilo Infermieristico",
    sources: degreeSources(BASE, ANNO, "scienze-infermieristiche-e-ostetriche-profilo-infermieristico", "Medicina", [
      { year: 1, corso: "MM12", anno2: ["GEN|1"] },
    ], false),
  },
  {
    programme: "Scienze Infermieristiche Specialistiche Nelle Cure Intensive e Nell?emergenza",
    sources: degreeSources(BASE, ANNO, "scienze-infermieristiche-specialistiche-nelle-cure-intensive-e-nell-emergenza", "Medicina", [
      { year: 1, corso: "MM10", anno2: ["GEN|1"] },
    ], false),
  },
  {
    programme: "Scienze Infermieristiche Specialistiche Nelle Cure Primarie e Infermieristica di Famiglia e Comunità",
    sources: degreeSources(BASE, ANNO, "scienze-infermieristiche-specialistiche-nelle-cure-primarie-e-infermieristica-di-famiglia-e-comunita", "Medicina", [
      { year: 1, corso: "MM11", anno2: ["GEN|1"] },
    ], false),
  },
  {
    programme: "Scienze Motorie per la Salute e L'invecchiamento Attivo",
    sources: degreeSources(BASE, ANNO, "scienze-motorie-per-la-salute-e-l-invecchiamento-attivo", "Medicina", [
      { year: 1, corso: "MT15", anno2: ["GEN|1"] },
      { year: 2, corso: "MT15", anno2: ["GEN|2"] },
    ], false),
  },
  {
    programme: "Scienze Riabilitative delle Professioni Sanitarie",
    sources: degreeSources(BASE, ANNO, "scienze-riabilitative-delle-professioni-sanitarie", "Medicina", [
      { year: 1, corso: "MM09", anno2: ["GEN|1"] },
      { year: 2, corso: "MM09", anno2: ["GEN|2"] },
    ], false),
  },
  {
    programme: "Semestre Filtro",
    sources: degreeSources(BASE, ANNO, "semestre-filtro", "Medicina", [
      { year: 1, corso: "SFM", anno2: ["PDS-MED-26|1", "PDS-ODO-26|1"] },
    ], false),
  },
];
